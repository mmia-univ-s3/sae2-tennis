...
class Jouer(db.Model):
    ...
    joueur1 = db.relationship("Joueur", foreign_keys=[_id_j1], backref=db.backref("inscire",
                             lazy="dynamic", cascade="all, delete-orphan"))
    joueur2 = db.relationship("Joueur", foreign_keys=[_id_j2], backref=db.backref("inscire",
                             lazy="dynamic", cascade="all, delete-orphan"))
