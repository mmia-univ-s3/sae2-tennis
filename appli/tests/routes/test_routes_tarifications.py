...
def test_reservation_create(client, testapp):
    with testapp.app_context():
        ...
        response = client.get('/formation/tarifications/categorie/8/ajout/reservation/', follow_redirects=True)
...
def test_reduction_create(client, testapp):
    with testapp.app_context():
        ...
        response = client.get('/formation/tarifications/categorie/8/ajout/reduction/', follow_redirects=True)
        assert b"Ajout d'une r" in response.data
