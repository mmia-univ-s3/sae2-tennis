...
def article_view(id_article):
    ...
    form = FormArticleUpdate(largeur=article.image.largeur if article.image is not None else 200, description=article.image.description if article.image is not None else "")
